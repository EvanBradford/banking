...
CREATE OR REPLACE PROCEDURE create_trans(TRANSID OUT NUMBER, TRANS IN varchar2, ACNTNUM_ID IN NUMBER)
IS
BEGIN
   INSERT INTO TRANSACTIONS (TRANSID, TRANS, ACNTNUM_ID) VALUES (trans_seq.nextval, TRANS, ACNTNUM_ID);
   TRANSID := transl_seq.currval;
   COMMIT;
END;