...
CREATE OR REPLACE PROCEDURE delete_account(ACNT IN NUMBER)
IS
BEGIN
   DELETE FROM BANKACCOUNTS WHERE
   ACNTNUM = ACNT;
END;

CREATE OR REPLACE PROCEDURE view_account(ACNT IN NUMBER)
IS
BEGIN
	SELECT * FROM BANKACCOUNTS WHERE
	ACNTNUM = ACNT;
END;